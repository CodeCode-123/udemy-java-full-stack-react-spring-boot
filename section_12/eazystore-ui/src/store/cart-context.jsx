...
export const CartProvider = ({ children }) => {
    ...
    //             );
    //         }
    //         // If the product is not the cart, add it
    //         return [...prevCart, {...product, quantity}];
    //     });
    // };
    ...
    const addToCart = (product, quantity) => {
        // trigger a state change when using state management tools like 
        // the built-in useReducer or Redux/React Redux
    ...
    // Calculate total quantity, the initial value of the accumulator is 0
