  ...
  return (
    <>
      ...
      <button 
        ...
        hover:bg-blue-700 transition duration-300'>Click me</button>
      <button 
        className='px-6 py-2 m-4 bg-red-400 text-white rounded-lg 
        hover:bg-red-700 transition duration-500 ease-in-out transform hover:scale-110'>Hover me</button>
