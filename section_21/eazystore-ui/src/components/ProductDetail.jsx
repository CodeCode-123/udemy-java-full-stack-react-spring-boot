...
export default function ProductDetail() {
    ...
    // used in component to access information about the current URL.
    // it returns a location object that provides current path, query parameters, 
    // and any state passed during navigation, if try to load additional information
    // from the backend, use loader or useEffect() to retrieve data from the backend
    ...
    return (
        <div className="min-h-[852px] flex items-center justify-center px-6 py-8 font-primary bg-normalbg dark:bg-darkbg">
            <div className="max-w-5xl w-full mx-auto flex flex-col md:flex-row md:space-x-8 px-6 p-8">
                ...
                <div
                    ref={zoomRef} // refer to the current element, store a reference to the DOM node
