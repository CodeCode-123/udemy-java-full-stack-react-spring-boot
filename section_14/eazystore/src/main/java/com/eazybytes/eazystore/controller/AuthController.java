...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto> apiLogin(@RequestBody
        ...
        try {
            // Manually authenticate a user, and there is no cookie to be stored
            // using Authentication, AuthenticationManager
            Authentication authentication = authenticationManager.authenticate(new
                    UsernamePasswordAuthenticationToken(loginRequestDto.username(),
                    loginRequestDto.password()));
            var userDto = new UserDto();
            var loggedInUser = (Customer) authentication.getPrincipal(); // change User to Customer
